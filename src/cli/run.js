...
function createApp(db, routes, middlewares, argv) {
  //xtoni
  console.log(`7: /src/server/index.js <- crea app express`);
...
module.exports = function (argv) {
  //xtoni
  console.log(`3: ${__filename.slice(-14)}`);

  const source = argv._[0];
  //xtoni
  console.log(` > source = ${source} - script start de package.json, 86`);
  ...
  function start(cb) {
    //xtoni
    console.log(`4: ${__filename.slice(-14)}, start(cb) 101`);
    ...
    return load(source).then((db) => {
      ...
      //xtoni
      console.log(`6: ${__filename.slice(-14)}, createApp() 136 -> 35`);
